	...
	var syncGrips = function (t){
		...
		for(var i=0; i<t.ln; i++){	//for each column
			...
			t.g[i].css({			//height and position of the grip is updated according to the table layout
				left: (c.offset().left - t.offset().left + c.outerWidth(false) + t.cs / 2) - (t.g[i].hasClass('JCLRLastGrip') ? ($('.content-scrollable')[0].offsetWidth - $('.content-scrollable')[0].clientWidth) / 2 : 0) + PX,
